...
```
@ECHO OFF
set SERVER_NAME=WASAdmin
 
title WebLogic_%SERVER_NAME%
set DOMAIN_HOME=D:\weblogic12.2.1\user_projects\domains\hanwhasystem
set LOG_DIR=D:\Log\WASLog\WASAdmin
...
set USER_MEM_ARGS=-Xms512m -Xmx512m -XX:PermSize=128m -XX:MaxPermSize=128m -verbosegc
...
title WebLogic_%SERVER_NAME%
set DOMAIN_HOME=D:\weblogic12.2.1\user_projects\domains\hanwhasystem
set LOG_DIR=D:\Log\WASLog\Managed01
set ADM_URL="t3://127.0.0.1:17001"
...
set USER_MEM_ARGS=-Xms1024m -Xmx1024m -XX:PermSize=256m -XX:MaxPermSize=256m
