...
![buffer argv](https://s01va.github.io/assets/images/2016-02-05-LOB-09/0.png)

(중략)

![buffer argv2](https://s01va.github.io/assets/images/2016-02-05-LOB-09/1.png)

이쯤 되니 주소지가 \xbffe ... 이 되는 것을 확인할 수 있다. 이를 이용하여 페이로드를 다음과 같이 입력하였다.

![exploit](https://s01va.github.io/assets/images/2016-02-05-LOB-09/2.png)
