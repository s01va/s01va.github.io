...
```
![cmd batch 0]({{site.url}}{{site.baseurl}}/blob/master/blob/master/_posts/2019-11-18-Windows-Batch-file/0.PNG)

![logfile1]({{site.url}}{{site.baseurl}}/blob/master/_posts/2019-11-18-Windows-Batch-file/1.PNG)
...
![logfile2]({{site.url}}{{site.baseurl}}/blob/master/_posts/2019-11-18-Windows-Batch-file/2.PNG)
...
![logfile3]({{site.url}}{{site.baseurl}}/blob/master/_posts/2019-11-18-Windows-Batch-file/3.PNG)
